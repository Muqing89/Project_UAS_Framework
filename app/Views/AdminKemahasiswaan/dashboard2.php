...
<head>
    ...
    <title>UKM Unitomo - Dashboard Admin Kemahasiswaan</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- ==================== Total Pengeluaran ==================== -->
                    <h5 class="font-weight-bold text-primary mb-3 mt-4">Total Pengeluaran</h5>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                Rp <?= number_format($total_pengeluaran_bulan_ini, 0, ',', '.') ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
