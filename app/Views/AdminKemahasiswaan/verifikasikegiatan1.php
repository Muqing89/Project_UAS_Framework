...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="settingsAdmin">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Data Table untuk Verifikasi Kegiatan oleh Admin Kemahasiswaan -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Daftar Usulan Kegiatan UKM</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($kegiatan as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalDetail<?= $row['id'] ?>">
                                                        Lihat Detail
                                                    </button>
                                                </td>
                                                <td>
    ...
    <!-- ModalDetail Admin Kemahasiswaan -->
    <?php foreach ($kegiatan as $row): ?>
        <div class="modal fade" id="modalDetail<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modalDetailLabel<?= $row['id'] ?>" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <form action="<?= base_url('prosesVerifikasiKegiatan/' . $row['id']) ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title" id="modalDetailLabel<?= $row['id'] ?>">Detail Kegiatan</h5>
                        ...
                        <div class="modal-body text-left">
                            ...
                            <p><strong>Status Admin:</strong> <?= esc($row['status_admin']) ?></p>
                        </div>
    ...
    <?php foreach ($kegiatan as $row): ?>
        ...
        <div class="modal fade" id="modalKomen<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modalKomenLabel<?= $row['id'] ?>" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form action="<?= base_url('simpanKomenKegiatan/' . $row['id']) ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalKomenLabel<?= $row['id'] ?>">Tulis Komentar</h5>
