                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="mt-3 text-primary">Pengajuan Kegiatan UKM</h3>
                        </div>

                        <!-- Alert Feedback -->
                        <div id="alert-success" class="alert alert-success d-none">Kegiatan berhasil dikirim!</div>
                        <div id="alert-error" class="alert alert-danger d-none">Terjadi kesalahan saat mengirim kegiatan.</div>
                        ...
                        <form id="form-kegiatan" action="index.php/dashboard" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- Tanggal & Waktu dalam satu baris -->
                                    <div class="row">
