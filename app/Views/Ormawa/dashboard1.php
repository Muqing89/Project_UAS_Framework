...
<head>
    ...
    <title>UKM Unitomo - Dashboard Ormawa</title>
    ...
    <!-- Costum dashboard template -->
    <link href="<?= base_url('/css/custom-dashboard.css') ?>" rel="stylesheet">
...
<body id="page-top">
            ...
            <div id="content">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <?php if (!empty($notifikasi)) : ?>
                                    <?php foreach ($notifikasi as $item) : ?>
                                        <?php if (isset($item['tipe'], $item['waktu'], $item['pesan'])) : ?>
                                            <?php
                                            // Warna ikon berdasarkan tipe notifikasi
                                            $warna = in_array($item['tipe'], [
                                                'verifikasi_kegiatan',
                                                'verifikasi_kegiatan_wr',
                                                'verifikasi_laporan',
                                                'verifikasi_laporan_wr'
                                            ]) ? 'bg-primary' : (
                                                in_array($item['tipe'], [
                                                    'penolakan_kegiatan',
                                                    'penolakan_kegiatan_wr',
                                                    'penolakan_laporan',
                                                    'penolakan_laporan_wr'
                                                ]) ? 'bg-danger' : 'bg-secondary'
                                            );

                                            // Ikon berdasarkan tipe notifikasi
                                            $ikon = in_array($item['tipe'], [
                                                'verifikasi_kegiatan',
                                                'verifikasi_kegiatan_wr',
                                                'verifikasi_laporan',
                                                'verifikasi_laporan_wr'
                                                ...
                                                in_array($item['tipe'], [
                                                    ...
                                                    'penolakan_laporan',
                                                    'penolakan_laporan_wr'
                                                ]) ? 'fa-times-circle' : 'fa-info-circle'
                                            );
                                            ?>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="mr-3">
                                                    <div class="icon-circle <?= esc($warna) ?>">
                                                        <i class="fas <?= esc($ikon) ?> text-white"></i>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="small text-gray-500">
                                                        <?= date('F j, Y, H:i', strtotime($item['waktu'])) ?>
                                                    </div>
                                                    <span class="font-weight-bold"><?= esc($item['pesan']) ?></span>
                                                </div>
                                            </a>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                <?php else : ?>
                                    <a class="dropdown-item text-center small text-gray-500">Tidak ada notifikasi baru</a>
                                <?php endif; ?>
                            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= base_url('generate-report') ?>" target="_blank"
                    ...
                    <!-- ==================== Bagian Kegiatan ==================== -->
                    <h5 class="font-weight-bold text-primary mb-3">Data Kegiatan</h5>
                    <div class="row">
                        <!-- Kegiatan Disetujui -->
                    ...
                    <!-- ==================== Bagian Laporan ==================== -->
                    <h5 class="font-weight-bold text-primary mb-3 mt-1">Data Laporan</h5>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Pie Chart Kegiatan</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <hr>
                                    Data jumlah pengajuan kegiatan.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Pie Chart Laporan</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-pie pt-4">
    ...
    <script>
        const kegiatanData = <?= json_encode($kegiatan_data) ?>;
        const laporanData = <?= json_encode($laporan_data) ?>;
    </script>
