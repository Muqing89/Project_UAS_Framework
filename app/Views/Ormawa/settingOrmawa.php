...
<head>
    ...
    <title>Pengaturan Akun Ormawa</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="card custom-card shadow-sm">
                    <a href="dashboardOrmawa" class="btn-kembali">← Kembali</a>
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Pengaturan Akun Ormawa</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('/settingsOrmawa/update') ?>" method="post">
                            <div class="mb-3">
