...
<head>
    ...
    <title>Pengaturan Akun Wakil Rektor II</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="card custom-card shadow-sm">
                    <a href="<?= base_url('dashboardWakilRektorII') ?>" class="btn-kembali">← Kembali</a>
                    <div class="card-header bg-dark text-white">
                        <h5 class="mb-0">Pengaturan Akun Wakil Rektor II</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('/settingsWakilRektor/update') ?>" method="post">
                            <div class="mb-3">
